...
class Module extends ApplicationModule
{
	...
	public static function initRoutes(DiInterface $di)
	{
		...
		$loader->registerNamespaces([
			'Skeleton\Backend' => __DIR__,
			'Skeleton\Backend\Controllers' => __DIR__ . '/controllers/',
			'Skeleton\Backend\Controllers\API' => __DIR__ . '/controllers/api/'
			], true)
			->register();
	...
	public function registerAutoloaders()
	{
		...
		$loader->registerNamespaces([
				...
				'Skeleton\Backend\Controllers' => __DIR__ . '/controllers/',
				'Skeleton\Backend\Controllers\API' => __DIR__ . '/controllers/api/',
				'Skeleton\Backend\Models' => __DIR__ . '/models/',
				'Skeleton\Backend\Library' => __DIR__ . '/lib/',
			], true)
			->register();
	}
	...
	public function registerServices($di)
	{
		...
		$di->set('view', function() {
			$view = new View();
			$view->setViewsDir(__DIR__ . '/../../../public/src/app/modules/backend/views/')
		...
		$di->set('dispatcher', function () use ($di) {
			...
			$dispatcher->setDefaultNamespace('Skeleton\Backend\\');
			return $dispatcher;
		});
